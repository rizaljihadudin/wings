                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-group mr-2">
                            <a type="button" class="btn btn-sm btn-outline-secondary" href="product.php">Kembali</a>
                        </div>
                    </div>
                    <h4>Edit Add</h4>
                    <div class="table-responsive" class="mb-5">
                        <form class="mb-3" method="post" action="insert.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="currency" name="currency" value="<?= $row['currency'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="disc">Discount</label>
                                <input type="text" class="form-control" id="disc" name="disc" value="<?= $row['discount'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="dimension">Dimension</label>
                                <input type="text" class="form-control" id="dimension" name="dimension" value="<?= $row['dimension'] ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="submit" name="update" value="Update Product" class="btn btn-sm btn-outline-primary">
                        </form>
                    </div>
                </main>
            </div>
